...
\sectionm{Trigger Beispiele} % (fold)
...
GROUP BY mnr;
\end{lstlisting}
\lstinputlisting[language=java,firstline=18,style=java]{Labs/Lab11_MapReduce/GroupByWithCount.java}
\subsection{Join}
\begin{lstlisting}[style=sql]
SELECT *
FROM registrierungen JOIN mitglieder USING (mnr);
\end{lstlisting}
\lstinputlisting[language=java,firstline=19,style=java]{Labs/Lab11_MapReduce/Join.java}
\lstinputlisting[language=java,firstline=8,style=java]{Labs/Lab11_MapReduce/DatasetTagger.java}
\subsection{Lösungsbeschrieb}
